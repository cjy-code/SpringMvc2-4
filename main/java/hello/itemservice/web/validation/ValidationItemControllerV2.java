...
//            bindingResult.addError(new FieldError("item", "quantity", "수량은 최대 9,999 까지 허용합니당 ㅎㅎ."));
//        }
//
//        //특정 필드가 아닌 복합 룰 검증
...
//        }
//        if(item.getQuantity() == null || item.getQuantity() >= 9999){
//            bindingResu lt.addError(new FieldError("item", "quantity",
//                    item.getQuantity(), false, null, null, "수량은 최대 9,999 까지 허용합니당 ㅎㅎ."));
//        }
//
//        //특정 필드가 아닌 복합 룰 검증
//        if(item.getPrice() != null && item.getQuantity() != null){
